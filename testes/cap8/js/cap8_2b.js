...
let div_todos_times = document.getElementById("times");
let rb_times = div_todos_times.getElementsByTagName("input");
for (let i = 0; i < rb_times.length; i++) {
    rb_times[i].addEventListener("change", troca_clube);
}
